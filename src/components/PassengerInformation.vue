  ...
  <div class="col-xs-12 col-md-12">
    <div class="list-block bar-form">
        <form class="form-horizontal" role="form">
            ...
            <!-- 提交按钮部分 -->
            <div class="form-group">
                <div class="infs-footer col-xs-offset-3">
                    ...
                    <button :disabled="!confirmSubmit" v-on:click="addUser"  type="button" class="btn btn-primary">新增乘客</button>
                </div>
            </div>
        </form>
    </div>
		...
		methods:{
		    ...
		    clearContent:function(){
		        ...
		        this.userInf.birthday='';
                        ...
                        addUser:function(){
                            this.status = true;
                            this.$dispatch('child-ste', this.status)
                        }
		},
                    created:function(){
