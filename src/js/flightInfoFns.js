...
exports.flightInfoCoerce = (flights) => {
  for (let flight of flights) {
    flight.flightCode = flight.flightCode.toUpperCase()
    flight.sharedFlightCode = flight.sharedFlightCode && flight.sharedFlightCode.toUpperCase()
  }
  return flights
}
